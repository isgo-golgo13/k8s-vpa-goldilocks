...
Goldilocks automates the provisoning of the VPA into a K8s Cluster and provides a VPA Analytics Dashscreen to allow
K8s SREs to configure or reconfigure the correct Pod spec resources for cpu/memory requests and cpu/memory limits. Goldilocks VPA is a K8s Controller that layers over K8s core VPA controllers.
